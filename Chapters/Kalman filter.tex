...
A widely used Bayesian filter is the Kalman filter. It provides a closed form solution to the Bayesian filtering equations in the case of linear dynamics and Gaussian noise. So when a system evolves linearly in time and both process noise and measurement noise are Gaussian, the Kalman filter gives an efficient recursive way to estimate the hidden state from noisy observations. 
